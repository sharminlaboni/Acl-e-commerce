    ...
    <div class="sidebar">
        ...
        <div class="navigationbar">
            <ul class="vertical-menu">
                ...
                <li class="vertical-header">Settings</li>
                <li>
                    <a href="javaScript:void();">
                        <img src="backend/assets/images/svg-icon/layouts.svg" class="img-fluid" alt="layouts"><span>Settings</span><i class="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul class="vertical-submenu">
                        <li><a href="{{ route('settings') }}"><i class="mdi mdi-circle"></i>Settings List</a></li>
                        <li><a href="{{ route('addSettingspage') }}"><i class="mdi mdi-circle"></i>Add Settings</a></li>
                    </ul>
                </li>

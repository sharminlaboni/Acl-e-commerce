                            ...
                            <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <textarea id="" type="text" class="form-control" name="p_title" id="inputp_title3" placeholder="p_title"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="p_asin" id="inputp_asin3" placeholder="p_asin">
                                    </div>
                                </div>

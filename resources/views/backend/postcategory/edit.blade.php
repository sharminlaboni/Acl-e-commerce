                    ...
                    <form method="post" action="{{route('postcategory.update',$postcategory->id)}}" enctype="multipart/form-data">
                      ...
                      @method('PATCH')
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="" type="text" class="form-control" name="category_list" value="{{ $postcategory->category_list }}" id="exampleInputEmail1" placeholder="Enter category_list">{{ $postcategory->category_list }}</textarea>

                ...
                <div class="card-header">
                    ...
                    <form method="post" action="{{route('postcategory.store')}}" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="" type="text" class="form-control" name="category_list" @error('category_list') is-invalid @enderror id="category_list" placeholder="Entercategory_list"></textarea>

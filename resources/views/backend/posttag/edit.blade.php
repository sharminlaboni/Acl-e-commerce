        ...
        <div class="col-lg-12">
            <div class="card m-b-15">
                ...
                <h5 class="card-title">Edit post tag</h5>
                    ...
                    <div class="card-body">
                    <form method="post" action="{{route('posttag.update',$posttag->id)}}" enctype="multipart/form-data">
                      @csrf
                      @method('PATCH')
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="" type="text" class="form-control" name="tag_list" value="{{ $posttag->tag_list }}" id="exampleInputEmail1" placeholder="Enter tag_list">{{ $posttag->tag_list }}</textarea>
